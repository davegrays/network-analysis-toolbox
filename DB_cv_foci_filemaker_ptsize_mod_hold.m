...
module_rgb{7} = [0 0 50]; % 
module_rgb{8} = [190 0 50]; % 
module_rgb{9} = [0 190 50]; % 
module_rgb{10} = [255 255 50]; % 
module_rgb{11} = [50 190 190]; % 
module_rgb{12} = [50 0 190]; % 
module_rgb{13} = [50 0 50]; % 
module_rgb{14} = [190 50 50]; %
for modnum=15:50
    module_rgb{modnum} = [rand * 255 rand * 255 rand * 255]; %
end
%%
size(cn,1)
for i=1:size(cn,1)
